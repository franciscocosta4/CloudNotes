                            ...
                            <ul class="list-group">
                                @foreach($ficheiros as $ficheiro)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <div class="column">
                                            <p style="font-size: 0.875rem; margin-bottom: 0.2rem;">
                                                {{ $ficheiro->user->name ?? 'Sem utilizador' }}
                                            </p>
                                            <a href="{{ Storage::url($ficheiro->file_path) }}"
                                                download="{{ $ficheiro->title }}.{{ pathinfo($ficheiro->file_path, PATHINFO_EXTENSION) }}"
                                                class="text-muted">
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="d-flex justify-content-left">
                                            ...
                                            {{ $points->withQueryString()->fragment('points')->links('pagination::bootstrap-4') }}
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
...
<style>
    ...
    .card {
        margin-bottom: 20px;
        /* Espaçamento consistente entre as tabelas */
    }
</style>